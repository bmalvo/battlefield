"""Suzuki is a monk who climbs a large staircase to the monastery as part of 
a ritual. Some days he climbs more stairs than others depending on the number 
...
def stairs_in_20(stairs: list) -> int:
    """count all stairs defeated by monk for 20 years"""
