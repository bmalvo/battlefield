...
you want to sneak out, which is quite simple, especially since the exit is 
...
An integer, the column number of your own seat 
(with the rightmost column having index 1).
...
def seats_in_theater(tot_cols, tot_rows, col, row):
    """number of people who sit strictly behind you and in your column or 
       to the left"""
