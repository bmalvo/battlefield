...
and Python) or max_load (in Ruby) amount of clothes. You are given a clothes 
...
amount of clothes to wash is 14, then you need 5 * 1.1 ^ (14 - 10) amount 
of water.
...
def how_much_water(water, load, clothes):
    """Calculate a amount of needed water"""
    if clothes > 2 * load:
        return 'Too much clothes'
    if clothes < load:
        return 'Not enough clothes'
    res = water * 1.1 ** (clothes - load)
    return round(res, 2)
