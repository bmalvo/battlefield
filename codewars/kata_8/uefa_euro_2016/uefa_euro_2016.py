"""Finish the uefaEuro2016() function so it return string just like 
...
def uefa_euro_2016(teams, scores):
    ...
    if scores[0] == scores[1]:
        response = f'At match {teams[0]} - {teams[1]}, teams played draw.'
    else:
        winner = teams[scores[1] > scores[0]]
        response = f'At match {teams[0]} - {teams[1]}, {winner} won!'
    return response
