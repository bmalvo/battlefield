...
Freud then wanted to study the illnesses created by this, and so he digged to
 the root of their desires. This led to some of the most important 
...
def to_freud(sentence):
    """exchange every word to sex word"""
    return ' '.join(['sex' for _ in sentence.split(' ')] if len(sentence) > 2 else '')
